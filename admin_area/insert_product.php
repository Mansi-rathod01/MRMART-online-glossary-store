        ...
        <form action="" method="post" enctype="multipart/form-data">
           ...
           <!-- keywords-->
             <div class="form-outline mb-4 w-50 m-auto">
                ...
                <input type="text" name="product_keywords" id="product_title" class="form-control" placeholder="Enter product keywords" autocomplete="off" required="required">
            </div>
            <!-- categories -->
            <div class="form-outline mb-4 w-50 m-auto">
...
?>
            ...
            <div class="form-outline mb-4 w-50 m-auto">
                ...
                <input type="file" name="product_image3" id="product_title" class="form-control"  autocomplete="off" required="required">
            </div>
            <!-- price-->
            <div class="form-outline mb-4 w-50 m-auto">
